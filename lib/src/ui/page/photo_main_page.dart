...
class _PhotoMainPageState extends State<PhotoMainPage>
  ...
  Color get titleColor => options.titleColor;
  Color get bottomColor => options.bottomColor;
  ...
  String get currentGalleryName {
    ...
    return currentPath?.name ?? "Change Folder";
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: Theme.of(context).copyWith(primaryColor: options.titleColor),
      child: DefaultTextStyle(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            actions: <Widget>[
              Padding(
                ...
                child: OutlineButton(
                  borderSide: BorderSide(color:options.bottomColor,width: 2.0,),
          ...
          bottomNavigationBar: _BottomWidget(
            ...
            onTapPreview: selectedList.isEmpty ? null : sure,
  ...
  void _showTip(String msg) {
    ...
    Scaffold.of(scaffoldKey.currentContext).showSnackBar(
      SnackBar(
        ...
        backgroundColor: bottomColor.withOpacity(0.7),
      ),
    );
  }
        ...
        children: <Widget>[
          Container(
            ...
            child: CircularProgressIndicator(
              valueColor: AlwaysStoppedAnimation(bottomColor),
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
